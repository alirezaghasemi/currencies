...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        // manual name validation translate
        'fa_name' => 'نام (فارسی)',
        'en_name' => 'نام (انگلیسی)',
        'family' => 'نام خانوادگی',
        'question' => 'سوال',
        ...
        'persian_family' => 'نام خانوادگی فارسی',
        'english_name' => 'نام انگلیسی',
        'english_family' => 'نام خانوادگی انگلیسی',
        ...
        'from_1' => 'تعداد ابتدایی',
        'to_1' => 'تعداد انتهایی',
        'price_1' => 'قیمت',

        'from_2' => 'تعداد ابتدایی',
        'to_2' => 'تعداد انتهایی',
        'price_2' => 'قیمت',

        'from_3' => 'تعداد ابتدایی',
        'to_3' => 'تعداد انتهایی',
        'price_3' => 'قیمت',

        'from_4' => 'تعداد ابتدایی',
        'to_4' => 'تعداد انتهایی',
        'price_4' => 'قیمت',
        'verify_code' => 'کد تایید شماره موبایل',
        'currency' => 'شناسه ارز',
        'transaction_volume' => 'حجم معامله',
